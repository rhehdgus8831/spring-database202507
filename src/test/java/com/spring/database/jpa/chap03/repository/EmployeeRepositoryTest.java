...
class EmployeeRepositoryTest {
    ...
    void insertBulk() {
        ...
        /*
            ...
            컨텍스트 창고 안에 있는 데이터를 재활용함.

            아래의 코드는 데이터 창고 즉, 영속성 컨텍스트를 지워버리는 코드
            (SELECT 확인을 위한 학습용 코드임)
        */
        em.flush();
        em.clear();
    }
    ...
    void orphanRemovalTest() {
       ...
       // employeeRepository.deleteById(1L);
        Employee remove = employees.remove(0);
    ...
    void nPlusOneTest() {
        ...
        departments.forEach(dept -> {
            System.out.println("dept = " + dept + dept.getDepartment());
        });
    ...
    void fetchJoinTest() {
        ...
        departments.forEach(d -> {
            System.out.println(" d = " + d + d.getEmployees());
                }
        );
    }
